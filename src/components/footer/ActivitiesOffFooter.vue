<template>
	...
	<footer
		v-show="showFooter"
		:class="[$style.activitiesOff, { [$style.sendToBottom]: userUnderstands }]">
		...
		<div :class="$style.acknowledgeBtns">
			<BaseButton
				aria-describedby="activitiesOffReminderMessage"
				text="I understand"
				@btnClick="acceptMessage"
				v-if="!userUnderstands" />
			<BaseButton text="Back to top" link url="#titleHeading" />
		</div>
	</footer>
</template>
