<!--
  ...
  TODO: This component...
    ...
    — will be used at the end of any given feature component. As these features are also stopping points in the lesson. Users will not be able to continue with the lesson until they have completed the feature. Until they have completed the feature, the Btn will be disabled. Once complete, they will be able to click it and then show the indicator.
...
<template>
	<BaseButton text="Complete?"></BaseButton>
	<BaseIndicator text="Scoll to continue"></BaseIndicator>
</template>
